...
namespace NSE.Pagamento.API.Data.Repository
{
    public class PagamentoRepository : IPagamentoRepository
    {
        ...
        public void AdicionarPagamento(Pagamento.API.Models.Pagamento pagamento)
        {
        ...
        public async Task<Pagamento.API.Models.Pagamento> ObterPagamentoPorPedidoId(Guid pedidoId)
        {
